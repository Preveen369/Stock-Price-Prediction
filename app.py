...
plt.title(f'{stock.strip().upper()} - Price vs 50-Day Moving Average')
plt.xlabel('Date')
plt.ylabel('Price')
plt.legend()
...
plt.plot(data.Close, 'g', label='Closing Price')
plt.title(f'{stock.strip().upper()} - Price vs Moving Averages (50 & 100 Days)')
plt.xlabel('Date')
plt.ylabel('Price')
plt.legend()
plt.grid(True, alpha=0.3)
...
plt.plot(data.Close, 'g', label='Closing Price')
plt.title(f'{stock.strip().upper()} - Price vs Moving Averages (100 & 200 Days)')
plt.xlabel('Date')
plt.ylabel('Price')
plt.legend()
plt.grid(True, alpha=0.3)
...
plt.title(f'{stock.strip().upper()} - Actual vs Predicted Stock Price')
plt.xlabel('Time')
plt.ylabel('Price')
plt.legend()
plt.grid(True, alpha=0.3)
